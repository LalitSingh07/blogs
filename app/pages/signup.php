...
if (!empty($_POST)) {
 ...
 // Validate terms
    if (empty($_POST['remember'])) {
      $errors['remember'] = 'please accept the term and conditions';
    } 
...
<main class="form-signin w-100 m-auto">
  <form method="post"> 
    <a href="home">
      <img class="mb-4"  src="<?=ROOT?>/assets/images/logos.png" alt="" width="300" height="170">
    </a>
    ...
    <div class="my-2">Already have account <a href="<?=ROOT?>/login">login here</a>
    </div>
