...
if (!loggedin()) {
  redirect("login"); // Add the missing redirect() function
}
...
if($section=="users"){
 require_once "../app/pages/admin/usercontroller.php";
}elseif($section=="categories"){
  require_once "../app/pages/admin/categoriescontroller.php";
}
elseif($section=="posts"){
  require_once "../app/pages/admin/postcontroller.php";
}
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Technical Sage</a>
    ...
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">Technical Sage</h5>
