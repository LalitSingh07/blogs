    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="#footer" class="nav-link px-2 link-body-emphasis">Contact</a></li>
        </ul>
        ...
        <div class="dropdown text-end">
          <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="<?=ROOT?>/assets/images/logos.png" alt="mdo" width="40" height="40" class="rounded-circle">
          </a>
  ...
  <div class="row mb-2 mx-2">
      ...
      <div class="col-md-6" >
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            ...
            <img class="bd-placeholder-img w-100" style="object-fit:cover;" height="250" src="<?=ROOT?>/assets/images/blog01.jpg" alt="" >
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            ...
            <img class="bd-placeholder-img w-100" style="object-fit:cover;" height="250" src="<?=ROOT?>/assets/images/blog02.jpg" alt="" >
